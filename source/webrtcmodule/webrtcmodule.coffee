...
export breakAllConnections = ->
    log "breakCurrentConnection"
    for uuid,conn of uuidToInConnection
        delete uuidToInConnection[uuid]
        conn.close()
        
    for uuid,conn of uuidToOutConnection
        delete uuidToOutConnection[uuid]
        conn.close()
